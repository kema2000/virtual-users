...
class JmeterProjectSummarySampler(option: JmeterOptions, dataMemory: JmeterDataMemory, myCookieManager: CookieManager) : CompositeSampler(mutableListOf<Sampler>(), "Jmeter View Project Summary") {

    init {
        val projectKey = dataMemory.projectMemory.recall()?.key
