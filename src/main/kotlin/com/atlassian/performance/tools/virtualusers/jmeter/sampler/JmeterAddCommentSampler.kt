...
class JmeterAddCommentSampler(option: JmeterOptions, dataMemory: JmeterDataMemory, myCookieManager: CookieManager)
    : CompositeSampler(mutableListOf<Sampler>(), "Jmeter Full Add Comment") {

    init {
        val issueKey = dataMemory.issueMemory.recall()?.key
